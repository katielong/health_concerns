...
d3.csv("data.csv", function(d) {
    ...
    var matrix = d.map(function(d) {
        return [+d.Alzheimer, +d.Arthritis, +d.Asthma, +d['Blood Sugar'], +d['Body Pain'], +d.Cancer, +d.Cardiovascular, +d.Cholesterol, +d.Coronavirus, +d.Diabetes, +d.Headache, +d.Hepatitis, +d['HIV-STD'], +d.Leukemia, +d.Lupus, +d['Mental Health'], +d.Obesity, +d.Others, +d['Thyroid Problems'], +d.Tuberculosis];
    });
